...
async function generateLLms() {
  ...
  const docsIndexContent = [
    '# GuBo UI - A Vue 3 based component library',
    '',
    '- GuBo UI is a Vue 3 based component library for developers, designers and product managers, with a set of high-quality components and rich features for building modern web applications.',
    '',
    '## Documentation',
    '',
