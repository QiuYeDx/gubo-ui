...
<template>
  <Transition name="g-fade-in" @enter="lock" @after-leave="cleanup">
...
.full-screen {
  ...
  &.g-fade-in-enter-active,
  &.g-fade-in-leave-active {
    .full-screen-container {
      transition: transform var(--g-transition-duration)
        var(--g-transition-function-ease-in-out-bezier);
    }
  }

  &.g-fade-in-enter-from,
  &.g-fade-in-leave-to {
    .full-screen-container {
