...
Popover is built with `GTooltip`. So for some duplicated attributes, please refer to the documentation of Tooltip.
...
| transition                         | popover transition animation, the default is g-fade-in-linear                                                                                                                        | ^[string]                                                                                                                                                                   | —                                                                          |
| show-arrow                         | whether a tooltip arrow is displayed or not. For more info, please refer to [GPopper](https://github.com/element-plus/element-plus/tree/dev/packages/components/popper)              | ^[boolean]                                                                                                                                                                  | true                                                                       |
