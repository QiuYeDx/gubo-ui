...
Use `css/scss` language to change the global or local color. We set some global color variables: `--g-rate-void-color`, `--g-rate-fill-color`, `--g-rate-disabled-void-color`, `--g-rate-text-color`. You can use like: `:root { --g-rate-void-color: red; --g-rate-fill-color: blue; }`.

### Default Variables

| Variable                      | Default Color                 |
| ----------------------------- | ----------------------------- |
| --g-rate-void-color          | var(--g-border-color-darker) |
| --g-rate-fill-color          | #f7ba2a                       |
| --g-rate-disabled-void-color | var(--g-fill-color)          |
| --g-rate-text-color          | var(--g-text-color-primary)  |
