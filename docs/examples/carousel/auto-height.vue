<template>
  <div class="block text-center" style="height: 300px">
    ...
    <g-carousel height="auto" autoplay>
      <g-carousel-item style="height: 100px">
        <h3 class="small justify-center" text="2xl">height 100px</h3>
      </g-carousel-item>
      <g-carousel-item style="height: 200px">
        <h3 class="small justify-center" text="2xl">height 200px</h3>
      </g-carousel-item>
      <g-carousel-item style="height: 300px">
...
.g-carousel__item:nth-child(2n) {
  background-color: #99a9bf;
}

.g-carousel__item:nth-child(2n + 1) {
