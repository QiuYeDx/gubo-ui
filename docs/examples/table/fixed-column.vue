<template>
  <g-table :data="tableData" style="width: 100%">
    ...
    <g-table-column fixed="right" label="Operations" min-width="120">
      <template #default>
        <g-button link type="primary" size="small" @click="handleClick">
          Detail
        </g-button>
        <g-button link type="primary" size="small">Edit</g-button>
      </template>
    </g-table-column>
  </g-table>
</template>
